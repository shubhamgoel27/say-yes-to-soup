...
export const SHIONOURA_JOURNAL: JournalEntry[] = [
  // ---------------- words ----------------
  {
    ...
    sub: 'I am home / welcome back. A call and its answer; neither works alone.',
  ...
  },
  {
    ...
    tab: 'customs',
    title: 'Tanabata',
    sub: 'The seventh night: Orihime and Hikoboshi meet across the Amanogawa, the river of heaven, once a year.',
